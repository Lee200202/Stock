目前交付：**2026-09-24-quality-v58**，請先讀 [v58 部署與驗證](docs/0924-v58/部署與驗證.md)。持股追蹤改成進場日最低、出場日最高（明講價以灰字附註），表格改用交易軸；Apps Script 33 檔整份替換後，須依文件第三節重算持股與歷史績效。以下舊版敘述保留為歷史，部署以本段文件為準。
