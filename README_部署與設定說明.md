最新 v47：[9/20 部署與驗收](docs/0920-v47/部署與驗收.md)，包含自動儲存同步、行情分工與明日取稿驗收。

> **2026/09/20 v46 更新**：自動稿交棒與人工優先、簡訊說明補充及郵件背景同步、Yahoo歷史分K備援與市場總覽。請先看 [完整流程與部署說明](docs/0919-v46/修改與部署流程.md)。Apps Script 30個檔案由本機交付，需另行部署。
